...
class Variables():
    ...
    titulo = "/html[1]/head[1]/title[1]"
    
    #BANDEJA DE CONSULTA
    tramites = "/html/body/app-root/div/div[1]/app-layout/div/app-header/div/app-nav/div/button[1]"
    consulta = "/html/body/div/div[2]/div/div/div/button[1]"
